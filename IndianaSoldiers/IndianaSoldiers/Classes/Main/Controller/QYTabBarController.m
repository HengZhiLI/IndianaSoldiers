...
- (void)addAllController{
    ...
    //抢购
    QYPurchaseViewController *pruchase = [[QYPurchaseViewController alloc]init];
...
//    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:NSStringFromClass([QYShopingViewController class]) bundle:nil];
    
//    QYShopingViewController *shoping = [storyboard instantiateInitialViewController];
